...
class _MainDashBoardState extends State<MainDashBoard> {
  final ItemScrollController yourItemScrollController = ItemScrollController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            if (constraints.maxWidth < 768) {
              ...
              return Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      separatorBuilder: (context, child) =>
                          Constants.sizedBox(width: 8, height: 0),
                  ...
                  Constants.sizedBox(width: 30, height: 0),
                ],
              );
            }
          },
      ...
      body: ScrollablePositionedList.builder(
        ...
        itemScrollController: yourItemScrollController,
